...
public class FileUploadController {
	...
	public String uploadFile(@RequestParam("uploadedFile") MultipartFile uploadedFile) {
		...
		String path = "E:/collaboration/" + fileName;
		
		//This buffer will store the data read from uploadedFile
	...
	// Iteratively read data from uploadedFile and write to outputfile
		int byteRead = 0;
		...
		return "File uploaded successfully: Total Bytes= " + totalBytes;
	}
